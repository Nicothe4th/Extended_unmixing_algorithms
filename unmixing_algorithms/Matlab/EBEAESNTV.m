function [P,A,W,S,Yh,V,Ji]=EBEAESNTV(Y,N,parameters,Po,oae)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Default hyper-parameters of EBEAE-SN&TV algorithm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if display==1
        disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
        disp('EBEAE with Total Variance & Sparse Noise');
...
function A = abundance(Y,P,W,V,lambda,parallel)
...
%   V           = matrix of sparse noise component
...
function P = endmember(Y,A,V,rho)

...
% D -> Vector de niveles de interacción no lineal
% V -> Matriz de ruido disperso
% Nf -> Número de endmembers fijos
% rho -> Factor de ponderación para la regularización
% parallel -> 1 para paralelizar, 0 para ejecución secuencial
%
% Salida:

...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 10:25:26 2025
...
errors_lmm_python = np.load('errors_lmm_python.npy')  # Cargar
data_matlab = loadmat('errors_lmm_matlab.mat')
...
E_zp = errors_lmm_python[0,:,:]
E_ap = errors_lmm_python[1,:,:]
E_pp = errors_lmm_python[2,:,:]
E_sp = errors_lmm_python[3,:,:]
E_tp = errors_lmm_python[4,:,:]


# Functions list (names of the methods)
functions = ['EBEAE', 'EBEAE-TV', 'EBEAESN', 'EBEAESNTV', 'ESSEAE']
